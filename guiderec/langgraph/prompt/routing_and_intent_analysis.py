...
2. "search" - 특정 식당의 정보(주소, 전화번호, 메뉴, 영업시간 등)를 조회하는 경우
   - 예: "나은이네 주소 알려줘", "숙성도 전화번호", "OO식당 메뉴 뭐 있어?", "XX 영업시간", "나은이네 정보 알려줘"
   - 특정 식당 이름이 언급되고 + 정보 조회 의도가 있을 때

3. "casual" - 일상적인 대화, 인사, 또는 맛집과 관련 없는 질문
   - 예: "안녕", "ㅎㅇ", "뭐해?", "넌 뭐야?", "고마워", "날씨 어때?", "나은이네 괜찮은데?", "거기 맛있었어"

JSON 형식으로만 응답하세요:
{{"intent": "recommendation"}} 또는 {{"intent": "search", "restaurant_name": "식당이름"}} 또는 {{"intent": "casual"}}
