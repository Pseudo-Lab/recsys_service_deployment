from .langgraph.langgraph_app import lite_app, Lite_GraphState
from langchain_core.runnables import RunnableConfig


def get_lite_results(query, session_id, state:Lite_GraphState) : 
    """
    ...
    try:
        ...
        # LangGraph 호출
        result_gs = lite_app.invoke(graph_state, config=config)
