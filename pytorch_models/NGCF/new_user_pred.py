...
def new_user_rec(interacted_items, num_recommendations=10, num_epochs=10) :
    ...
    _, top_indices = torch.topk(rate_batch.view(-1), num_recommendations)
