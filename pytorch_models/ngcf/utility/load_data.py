...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        with open(train_file) as f:
            for l in f.readlines():
                if len(l) > 0:
                    ...
                    for i in l[1:]:
                        self.user_item_src.append(uid)
                        self.user_item_dst.append(int(i))
        ...
        self.data_dict = {
            ...
            ("user", "ui", "item"): (self.user_item_src, self.user_item_dst),
            ("item", "iu", "user"): (self.user_item_dst, self.user_item_src),
        }
